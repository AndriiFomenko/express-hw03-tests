...
Проект було реорганізовано згідно з паттерном MVC (Model-View-Controller) та кращими практиками Express.js.
...
**Відповідальність**: Визначення URL endpoints та підключення middleware
...
- `demoAuth()` - демо аутентифікація
- `strictAuth()` - строга аутентифікація
...
2. **Middleware** обробляє запит (логування, валідація, аутентифікація)
